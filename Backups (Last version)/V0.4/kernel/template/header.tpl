...
<div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
      <div class="top-left-part"><a class="logo" href="<?php echo URL ?>"><b><img src="<?php echo URL ?>/style/images/logo.png" alt="home" style="margin-top:5px;"/></b></a></div>
  ...
  <div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
     <ul class="nav" id="side-menu">
        ...
        <li> <a href="<?php echo URL ?>" class="waves-effect active"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i> <span class="hide-menu"> <?php echo $lang['menu.main.start'] ?> <span class="fa arrow"></span> </span></a></li>
		...
		<li> <a href="#" class="waves-effect"><i data-icon="/" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu"><?php echo $lang['menu.main.champs'] ?><span class="fa arrow"></span></span></a>
		 ...
		 <li> <a href="#" class="waves-effect"><i data-icon="/" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu"><?php echo $lang['menu.main.summoners'] ?><span class="fa arrow"></span></span></a>
          <ul class="nav nav-second-level">
        ...
        <li> <a href="<?php echo URL ?>/game/serverstatus" class="waves-effect"><i data-icon="/" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu"><?php echo $lang['menu.main.serverstatus'] ?><span class="fa arrow"></span></span></a> </li>
</ul>
    </div>
  </div>