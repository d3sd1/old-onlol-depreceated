			...
			<?php
			   if(is_array(@$_SESSION['onlol_summonersSearched']))
			   {
				   ...
				   $summonerRecentSearchedColor = 0;
					foreach(array_reverse($_SESSION['onlol_summonersSearched']) as $summonerName => $sumReg)
					{
						...
						echo '<div class="col-sm-2"><div class="white-box text-center '.$boxColor.'"><a href="'.URL.'/summoner/'.$sumReg.'/'.$summonerName.'" class="text-white"><i class="fa fa-user fa-fw" data-icon="v"></i><br/>'.$summonerName.'</a></div></div>';
