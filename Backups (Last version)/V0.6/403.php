...
<title><?php echo $lang['title.error.403'] ?></title>
...
<section id="wrapper" class="error-page">
  <div class="error-box">
    <div class="error-body text-center">
      <h1>403</h1>
      <h3 class="text-uppercase"><?php echo $lang['page.error.403.title'] ?></h3>
      <p class="text-muted m-t-30 m-b-30"><?php echo $lang['page.error.403.desc'] ?></p>
