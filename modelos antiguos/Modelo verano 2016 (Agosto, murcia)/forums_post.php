...
<div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed <?php if(!empty($_COOKIE['onlol_sidebar']) && @$_COOKIE['onlol_sidebar'] == 'min') {echo 'sidebar-mini';} ?>">
	...
	<!-- Start Forums -->
<main id="main-container" style="background-image: url(<?php echo $config['web.url'] ?>/assets/game/champions/splash/FiddleSticks_0.jpg); background-repeat: no-repeat; background-size: cover; background-attachment: fixed;"><div class="content content-narrow">
<ol class="breadcrumb push-15">
	...
	<li><a class="link-effect" href="<?php echo $config['web.url'].'/forums/topic/'.$post_details[0] ?>"><?php echo $post_details[1] ?></a></li>
</ol>
<div class="block">
