                ...
                <div class="container">
                    ...
                    ================================================== -->
						...
						<div class="pcss3t pcss3t-layout-top-center pcss3t-effect-slide-left pcss3t-effect-slide-top pcss3t-height-auto">
							...
							<label for="tab2"><i class="icon-book"></i>Historia</label>
							...
							<label for="tab6"><i class="icon-bookmark"></i>Consejos</label>
							
							<input type="radio" name="pcss3t" id="tab7" class="tab-content-7">
							<label for="tab7"><i class="icon-eye-open"></i>Counters</label>
							...
							<ul>
								...
								<li class="tab-content tab-content-3">
                                    ...
                                    <ul role="tablist_sub">
                                        ...
                                        <li style="display:inline;"><button type="button" href="#tree" data-toggle="tab" style="background:url(<?php echo URL ?>/style/images/home/bg/tree.jpg);background-repeat: repeat; background-size: 100%; background-attachment: fixed; margin-left:2.5%;" class="btn btn-primary rounded btn-lg">Bosque retorcido</button></li>
                                        <li style="display:inline;"><button type="button" href="#scar" data-toggle="tab" style="background:url(<?php echo URL ?>/style/images/home/bg/scar.jpg);background-repeat: repeat; background-size: 100%; background-attachment: fixed; margin-left:2.5%;" class="btn btn-primary rounded btn-lg">Cicatriz de cristal</button></li>
