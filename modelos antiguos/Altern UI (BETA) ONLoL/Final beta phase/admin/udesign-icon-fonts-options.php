...
function icon_fonts_options_page_callback() {
	...
	<div class="wrap">
            <h2><?php _e('U-Design Icon Fonts Options'); ?></h2>
            <?php // settings_errors(); ?>

            <h2 class="nav-tab-wrapper">
                    <a href="?page=udesign_icon_fonts_options_page&tab=fontello" class="nav-tab <?php echo $tab == 'fontello' ? 'nav-tab-active' : ''; ?>"><?php _e('Fontello'); ?></a>
                    <a href="?page=udesign_icon_fonts_options_page&tab=font_awesome" class="nav-tab <?php echo $tab == 'font_awesome' ? 'nav-tab-active' : ''; ?>"><?php _e('Font Awesome'); ?></a>
            </h2>
...
function udesign_field_font_awesome_options_callback() {
	echo '<p>' . esc_html__('By default the Font Awesome fonts and styles are loaded within the theme. '
                ...
                . 'If you would like to remove Font Awesome from the available icon fonts, please use the option below to disable them:') . '</p>';
}
...
function udesign_icon_font_func( $atts ) {
    extract(shortcode_atts(array(
	    'name' => esc_html__('icon-emo-happy'),
	    'color' => '',
	    'size' => '',
    ), $atts));
