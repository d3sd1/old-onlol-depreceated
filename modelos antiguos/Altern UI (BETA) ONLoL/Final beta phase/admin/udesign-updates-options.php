...
function updates_options_page_callback() {
	...
	<div class="wrap">
            <h2><?php _e('U-Design Theme Update Options'); ?></h2>
...
function u_design_alternative_update_methods_info() {
    ob_start(); ?>
            ...
            <h3>Manual update:</h3>
            <p><strong>Please note:</strong> It's always a great idea to make a backup of the theme's folder <strong>/wp-content/themes/u-design/</strong>, or better yet, a full backup of your site including the database before proceeding with an update.</p>
            ...
            <p>Here's a couple of methods we usually recommend for updating the theme manually:</p>
            <ul>
                <li><span class="dashicons dashicons-admin-tools" style="color:#696969;"></span> <strong>Method 1:</strong> You may simply drag-and-drop using your favorite FTP client the latest version of the theme (unzipped "u-design" folder) over the existing ones in your web server. This will overwrite the current theme files with the new ones (example: <a rel="nofollow" target="_blank" href="http://www.screenr.com/F7hs">http://www.screenr.com/F7hs</a>). That way if you have uploaded any additional files to the theme's folder, they will not be deleted.</li>
                <li><span class="dashicons dashicons-admin-tools" style="color:#696969;"></span> <strong>Method 2:</strong> Go to <a title='Go to Appearance &rarr; Themes setion' href='<?php echo admin_url(); ?>themes.php' target="_blank">Appearance &rarr; Themes</a> section, activate another theme temporarily which will de-activate the "U-Design" theme automatically. At this point go ahead and delete the "U-Design" theme (don't worry, you will not lose any of your themes' options since those are saved in the database). Then upload, install and activate the latest version of the "U-Design" theme as if doing it for the first time.</li>
            </ul>
            <p>If you have any caching plugins active or server side caching or <a href="http://en.wikipedia.org/wiki/Content_delivery_network" title="What is CDN?" target="_blank">CDN</a> don't forget to clear the cache.</p>
            <p><span class="dashicons dashicons-info" style="color:#696969;"></span> Now, <strong>if you have modified any core theme files in the past</strong> (those could be CSS, PHP, JS or ther files) but you haven't been keeping track of your changes then you can use some 'diff' tools to locate exactly what was modified and thus be able to re-apply those changes after the update. For your reference, it's always better to use a "child" theme for customizations that way your changes will be safe with future updates of the "parent" theme, we offer a "child" theme for U-Design <a rel="nofollow" target="_blank" href="http://dreamthemedesign.com/u-design-support/discussion/692/who-wants-a-child-theme-for-u-designss">HERE</a>.</p>
            <p>For a full list of affected files in the latest release please refer to the theme's "Changelog".</p>
            <p>Should you have any questions regarding theme updates feel free to post in the <a target="_blank" title="How do I update the theme!" href="http://dreamthemedesign.com/u-design-support/discussion/13/how-do-i-update-the-theme/p1">support forum</a>.</p>
<?php
    echo ob_get_clean();
}
