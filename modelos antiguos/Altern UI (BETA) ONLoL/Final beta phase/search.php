...
<html lang="en">
    <head>
        <title>ONLoL ~ Buscador avanzado</title>
        <meta charset="utf-8">
...
else
{
			...
			if(empty($_GET['name']))
			{
				...
				<section class="content padding3x error-404 not-found" style="background-image: url('.URL.'/style/images/not_found/background.jpg); background-repeat:no-repeat; background-size: cover; color:white;">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
