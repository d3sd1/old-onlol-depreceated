                ...
                <div class="body-content animated fadeIn" style="background-image: url(<?php echo URL ?>/game/champions/<?php echo $main_champ ?>/splash/0.jpg); background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
                    ...
                    <div class="divider"></div>
						 <div class="panel panel-lilac rounded shadow">
							...
							$champmasterytotal_data_array_count_6 = 0;
							$champmasterytotal_data_array_count_7 = 0;
							foreach($champmasterytotal_data_array as $champmasterytotal_data_array_data)
							{
								...
								if($champmasterytotal_data_array_data['level'] == 6)
								{
									$champmasterytotal_data_array_count_6 = $champmasterytotal_data_array_count_6+1;
								}
								if($champmasterytotal_data_array_data['level'] == 7)
								{
									$champmasterytotal_data_array_count_7 = $champmasterytotal_data_array_count_7+1;
								}
							}	?>
							...
							<div class="table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <span class="pull-left text-capitalize"><?php echo lang::trans('profile_box_champmastery_champswithmastery') ?> 7</span>
                                                                    <span class="pull-right text-strong fg-teals"><?php echo $champmasterytotal_data_array_count_7 ?></span>
                                                                </td>
                                                            </tr>
															<tr>
                                                                <td>
                                                                    <span class="pull-left text-capitalize"><?php echo lang::trans('profile_box_champmastery_champswithmastery') ?> 6</span>
                                                                    <span class="pull-right text-strong fg-teals"><?php echo $champmasterytotal_data_array_count_6 ?></span>
                                                                </td>
                                                            </tr>
															<tr>
                                                                <td>
