    ...
    return {
        ...
        handleSound: function () {
            if($('.page-sound').length){
                ion.sound({
                    sounds: [
                        {name: "water_droplet_3", volume: 0.2}
                    ],
                    path: '/style/global/plugins/bower_components/ionsound/sounds/',
                    preload: true
                });
        ...
        handleBoxModal: function () {
            ...
            $('#logout').on('click', function(){
                ...
                ion.sound.play('camera_flashing');
                bootbox.dialog({
                    message: lang_exit_txt,
                    title: lang_exit_txt_title,
