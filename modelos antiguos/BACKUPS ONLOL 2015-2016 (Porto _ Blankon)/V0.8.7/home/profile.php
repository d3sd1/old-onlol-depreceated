...
else /* Summoner is already on database */
{
...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <body class="page-session page-sound page-header-fixed page-sidebar-fixed">
        ...
        <script src="<?php echo URL ?>/style/global/plugins/bower_components/ionsound/js/ion.sound.min.js/style/global/plugins/bower_components/ionsound/js/ion.sound.min.js"></script>
