					...
					<div class="col-sm-6 col-md-12" style="background-color: white; opacity: 0.95;">
						<ul class="nav nav-tabs" role="tablist">
                            ...
                            <div id="grid_54f5908f6efc8" class="col-sm-6 col-md-6 grid-container grid-x" style="padding: 3% 3% 0% 3%; margin-left:25%; margin-top:-4%;margin-bottom:3%;" data-item-style="tpl-item-style5" data-open-state="modal" data-size-width="64" data-size-height="64" data-item-size="4x3" data-column="4" data-size-gutter="10">
								...
								{"id":1,"skill":"P","cooldowns":"","title":"Pasiva - <?php echo $db->query('SELECT passive_name FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0] ?>","format":"video","media":"<div class=\"mejs-wrapper video\"><video poster=\"<?php echo URL ?>/style/images/video/error.png\" preload=\"auto\" autoplay loop width=\"100%\">\r\n<source type=\"video\/mp4\" src=\"http://d28xe8vt774jo5.cloudfront.net/abilities/videos/0<?php if($db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0] > 100) {echo $db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_id'].'"')->fetch_row()[0];} else { echo '0'.$db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_id'].'"')->fetch_row()[0]; } ?>_01.mp4\" \/><\/video><\/div>","link":"#","post_type":"post","grid_size":"normal cat4","thumb":"<?php echo URL ?>/style/images/base/champions/kit/<?php echo $champ['champ_keyname'] ?>/passive.png","content":"<?php echo addslashes($db->query('SELECT passive_description FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0]) ?>","_logo":"images\/logo\/2.png","categories":[{"cat_id":4,"title":"Entertainment","color":"#007AFF","slug":"category_4","link":"#"}],"tags":[]},
								{"id":2,"skill":"Q","cooldowns":"Enfriamientos: <?php echo $db->query('SELECT q_cooldown FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0] ?>","title":"Q - <?php echo addslashes($db->query('SELECT q_name FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0]) ?>","format":"video","media":"<div class=\"mejs-wrapper video\"><video preload=\"auto\" poster=\"<?php echo URL ?>/style/images/video/error.png\" autoplay loop width=\"100%\">\r\n<source type=\"video\/mp4\" src=\"http://d28xe8vt774jo5.cloudfront.net/abilities/videos/0<?php if($db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0] > 100) {echo $db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0];} else { echo '0'.$db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0]; } ?>_02.mp4\" \/><\/video><\/div>","link":"#","post_type":"post","grid_size":"normal cat4","thumb":"<?php echo URL ?>/style/images/base/champions/kit/<?php echo $champ['champ_keyname'] ?>/q.png","content":"<?php echo addslashes($db->query('SELECT q_description FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0]) ?>","_logo":"images\/logo\/2.png","categories":[{"cat_id":4,"title":"Entertainment","color":"#007AFF","slug":"category_4","link":"#"}],"tags":[]},
								{"id":3,"skill":"W","cooldowns":"Enfriamientos: <?php echo $db->query('SELECT w_cooldown FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0] ?>","title":"W - <?php echo addslashes($db->query('SELECT w_name FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0]) ?>","format":"video","media":"<div class=\"mejs-wrapper video\"><video preload=\"auto\" poster=\"<?php echo URL ?>/style/images/video/error.png\" autoplay loop width=\"100%\">\r\n<source type=\"video\/mp4\" src=\"http://d28xe8vt774jo5.cloudfront.net/abilities/videos/0<?php if($db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0] > 100) {echo $db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0];} else { echo '0'.$db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0]; } ?>_03.mp4\" \/><\/video><\/div>","link":"#","post_type":"post","grid_size":"normal cat4","thumb":"<?php echo URL ?>/style/images/base/champions/kit/<?php echo $champ['champ_keyname'] ?>/w.png","content":"<?php echo addslashes($db->query('SELECT w_description FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0]) ?>","_logo":"images\/logo\/2.png","categories":[{"cat_id":4,"title":"Entertainment","color":"#007AFF","slug":"category_4","link":"#"}],"tags":[]},
								{"id":4,"skill":"E","cooldowns":"Enfriamientos: <?php echo $db->query('SELECT e_cooldown FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0] ?>","title":"E - <?php echo addslashes($db->query('SELECT e_name FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0]) ?>","format":"video","media":"<div class=\"mejs-wrapper video\"><video preload=\"auto\" poster=\"<?php echo URL ?>/style/images/video/error.png\" autoplay loop width=\"100%\">\r\n<source type=\"video\/mp4\" src=\"http://d28xe8vt774jo5.cloudfront.net/abilities/videos/0<?php if($db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0] > 100) {echo $db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0];} else { echo '0'.$db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0]; } ?>_04.mp4\" \/><\/video><\/div>","link":"#","post_type":"post","grid_size":"normal cat4","thumb":"<?php echo URL ?>/style/images/base/champions/kit/<?php echo $champ['champ_keyname'] ?>/e.png","content":"<?php echo addslashes($db->query('SELECT e_description FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0]) ?>","_logo":"images\/logo\/2.png","categories":[{"cat_id":4,"title":"Entertainment","color":"#007AFF","slug":"category_4","link":"#"}],"tags":[]},
								{"id":5,"skill":"R","cooldowns":"Enfriamientos: <?php echo $db->query('SELECT r_cooldown FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0] ?>","title":"R - <?php echo addslashes($db->query('SELECT r_name FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0]) ?>","format":"video","media":"<div class=\"mejs-wrapper video\"><video preload=\"auto\" poster=\"<?php echo URL ?>/style/images/video/error.png\" autoplay loop width=\"100%\">\r\n<source type=\"video\/mp4\" src=\"http://d28xe8vt774jo5.cloudfront.net/abilities/videos/0<?php if($db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0] > 100) {echo $db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0];} else { echo '0'.$db->query('SELECT champ_id FROM lol_champs WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0]; } ?>_05.mp4\" \/><\/video><\/div>","link":"#","post_type":"post","grid_size":"normal cat4","thumb":"<?php echo URL ?>/style/images/base/champions/kit/<?php echo $champ['champ_keyname'] ?>/r.png","content":"<?php echo addslashes($db->query('SELECT r_description FROM lol_champs_skills WHERE champ_keyname="'.$champ['champ_keyname'].'"')->fetch_row()[0]) ?>","_logo":"images\/logo\/2.png","categories":[{"cat_id":4,"title":"Entertainment","color":"#007AFF","slug":"category_4","link":"#"}],"tags":[]}
								]}</script>
                            </div>
                                    <div class="col-sm-6 col-md-4 text-light" data-background="#3498db" style="padding: 2% 2% 1.5% 2%; background-color: rgb(52, 152, 219);border-radius: 20px 0px 0px 20px;-moz-border-radius: 20px 0px 0px 20px;-webkit-border-radius: 20px 0px 0px 20px;border: 0px solid #000000;">
                                      <h2>Base</h2>
