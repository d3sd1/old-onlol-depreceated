...
window.averta = {}, function ($) {
    ...
    averta.EventDispatcher = function () {
        ...
        for (var key in instance)
            ...
            if (this.listeners[event]) {
                for (var i = 0, l = this.listeners[event].length; l > i; ++i)
    ...
    MSLayerEffects.setup = function () {
        if (!installed) {
            ...
            _2d = window._css2d && window._cssanim && !o, st.defaultValues = {left: 0, top: 0, opacity: 1, right: 0, bottom: 0}, st.defaultValues[transform_css] = "", st.rf = 1, st.presetEffParams = {random: "30|300", "long": 300, "short": 30, "false": !1, "true": !0, tl: "top left", bl: "bottom left", tr: "top right", br: "bottom right", rt: "top right", lb: "bottom left", lt: "top left", rb: "bottom right", t: "top", b: "bottom", r: "right", l: "left", c: "center"}, st.fade = function () {
                return _fade
    ...
    window.MSLayerElement = function () {
        this.$cont = $("<div></div>").addClass("layer-cont"), this.start_anim = {name: "fade", duration: 1e3, ease: "linear", delay: 0}, this.end_anim = {duration: 1e3, ease: "linear"}, this.type = "text", this.resizable = !0, this.minWidth = -1, this.__cssConfig = ["margin-top", "padding-top", "margin-bottom", "padding-left", "margin-right", "padding-right", "margin-left", "padding-bottom", "font-size", "line-height", "width", "left", "right", "top", "bottom"], this.baseStyle = {}
    };
    ...
    p.__playAnimation = function (animation, css) {
        ...
        if (this.slide.ready) {
            var factor, isPosition, layer_cont = this.slide.$layers, width = parseFloat(layer_cont.css("width")), height = parseFloat(layer_cont.css("height"));
    ...
    p.onSwipeStart = function () {
        ...
        this.hasParallaxLayer && ("swipe" === this.slider.options.parallaxMode ? this.view.addEventListener(MSViewEvents.SCROLL, this.swipeParallaxMove, this) : this.$element.on("mousemove", {that: this}, this.mouseParallaxMove).on("mouseleave", {that: this}, this.resetParalax))
        ...
        var that = e.data.that, os = that.$element.offset(), slider = that.slider;
        ...
        }), this.video && (-1 === this.video.indexOf("?") && (this.video += "?"), this.vframe = $("<iframe></iframe>").addClass("ms-slide-video").css({width: "100%", height: "100%", display: "none"}).attr("src", "about:blank").appendTo(this.$element), this.vpbtn = $("<div></div>").addClass("ms-slide-vpbtn").click(function () {
            that.__playVideo()
        ...
        if (this.view.create(startSlide), 0 === this.so.preload && this.view.slideList[0].loadImages(), this.scroller = this.view.controller, this.so.wheel) {
            ...
            this.wheellistener = function (event) {
                ...
                if (!(400 > current_time - last_time)) {
                    ...
                    var delta = Math.abs(e.detail || e.wheelDelta), scrollThreshold = 15;
    ...
    p.__setupSlides = function () {
        ...
        "boxed" !== lo && "partialview" !== lo && (this.options.fullwidth = !0), ("fullscreen" === lo || "autofill" === lo) && (this.options.fullheight = !0), "partialview" === lo && this.$element.addClass("ms-layout-partialview"), ("fullscreen" === lo || "fullwidth" === lo) && ($(window).bind("resize", {that: this}, this._updateLayout), this._updateLayout()), $(window).bind("resize", this.slideController.resize_listener)
    }, p._updateLayout = function (event) {
        var that = event ? event.data.that : this, lo = that.options.layout, $element = that.$element;
...
}, MSViewEvents.SWIPE_START = "swipeStart", MSViewEvents.SWIPE_END = "swipeEnd", MSViewEvents.SWIPE_MOVE = "swipeMove", MSViewEvents.SWIPE_CANCEL = "swipeCancel", MSViewEvents.SCROLL = "scoll", MSViewEvents.CHANGE_START = "slideChangeStart", MSViewEvents.CHANGE_END = "slideChangeEnd", function ($) {
    "use strict";
    ...
    p.setup = function () {
        ...
        var thumb_ele = $(slide.$element.find(".ms-thumb")), that = this, thumb_frame = $("<div></div>").addClass("ms-thumb-frame").append(thumb_ele).append($('<div class="ms-thumb-ol"></div>')).bind("click", function () {
    ...
    window.MSFlickrV2 = function (slider, options) {
        ...
        if (this.slider = slider, this.slider.preventInit = !0, !options.key)
    ...
    p.init = function () {
        ...
        for (var slide, slides = this.slider.api.view.slideList, i = 0, l = slides.length; i !== l; i++)
            slide = slides[i], slide.$layers && (slide.$layers.wrap('<div class="ms-scroll-parallax-cont"></div>'), slide.$scrollParallaxCont = slide.$layers.parent());
