...
<html lang="en">
    <head>
		...
		<!-- FB -->
		<meta property="og:title" content="ONLoL" />
		<meta property="og:description" content="Buscar invocadores, estadísticas, competiciones, torneos, LCS... ¡Todo lo que necesitas sobre League of Legends!" />
		<meta property="og:image" content="<?php echo URL ?>/style/images/logo.png" />
        ...
        <script type="text/template" id="tpl-single-open-state">
            ...
            <%= title %>
            <span class="share">
			<a target="share" href="http://www.facebook.com/sharer.php?s=100&p[url]=http://onlol.net/&p[title]=ONLoL&p[summary]=¿Quieres ver toda la información sobre <%= champ %>?&p[images][0]=<?php echo URL ?>/style/images/base/champions/splash/<%= keyname %>_0.jpg">
            <i class="switch-share icon_link_alt"></i>
            <i class="switch-item social_facebook"></i>
            </a>
			<a target="share" href="http://twitter.com/share?url=http://www.onlol.net/champions/<%= champ %>&text=¿Quieres saber todo sobre <%= champ %>? ¡Descúbrelo en ONLoL!"><i class="social_twitter"></i></a>
            <a style="visibility:hidden;" href="#"><i class="social_googleplus"></i></a>
            <a style="visibility:hidden;" href="#"><i class="social_pinterest"></i></a>
            </span>
            </h2>
            <%= content %>
            <div class="meta row">
