                ...
                <div class="container" >
                    <div class="row padding2x" >
                        ...
                        <div class="col-md-8">
                            ...
                            <br>
                            <form class="clearfix" action="<?php echo URL ?>/" method="post" id="contactform" data-toggle="validator" role="form">
                                ...
                                <span class="form-field small-field">
                                    <input type="email" name="email" id="email" value="" tabindex="2" class="form-control" placeholder="Email" required>
                                </span>
                                <span class="form-field small-field">
                                    <input type="text" name="subject" id="subject" value="" tabindex="3" class="form-control" placeholder="Motivo de contato" required>
                                </span>
								<span class="form-field small-field">
                                    <input type="text" name="subject" id="subject" value="" tabindex="3" class="form-control" placeholder="Motivo de contato" required>
                                </span>
                                <span class="form-field">
                                    <textarea name="comment" cols="50" rows="6" tabindex="4" class="form-control" placeholder="Detalles del contacto" required></textarea>
                                </span>
                                <button name="submit" type="submit" id="submit-button" tabindex="5" value="Submit" class="btn btn-primary sharp">Submit Now</button>
							<!--<div style="float:right"><a href="#" class="social_flickr"></a>
                            <a href="#" class="social_linkedin"></a>
                            <a href="#" class="social_youtube"></a>
                            <a href="#" class="social_tumblr"></a>
                            <a href="#" class="social_blogger"></a></div>-->
                            </form>
                        </div>
                        <div class="col-md-4">
