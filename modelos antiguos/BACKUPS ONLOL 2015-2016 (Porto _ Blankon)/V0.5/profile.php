			...
			<div class="col-md-12" style="margin-top:-3%;">
                                    <div role="tabpanel" class="tabs">
                                        <ul class="nav nav-tabs">
                                            <?php if($profile_level < '30' or $profile_league == 'U') { echo '<li class="text-center" style="width:10%;"><a href="#start" data-toggle="tab" aria-expanded="false">Inicio</a></li>
											...
											<li class="text-center" style="width:10%;"><a href="#stream" data-toggle="tab" aria-expanded="false">Stream</a></li>
                                        </ul>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="ranked">
												<div class="row">
													<div class="col-md-3 profileinfoseasons">
													<ul>
													<li>Season 2016</li>
													<li>Season 2015</li>
													<li>Season 2014</li>
...
<div class="row"><div id="chart_winrate" style="width:30%; margin-left:2%; height: 300px; margin-bottom:4%; opacity:0.95;"></div>
<div id="chart_kda" style="width:30%; height: 300px; margin-left:35%; margin-top:-29.6%; margin-bottom:4%; opacity:0.95;"></div>
<div id="chart_positions" style="width:30%; height: 300px; margin-top:-29.6%; margin-right:2%; float:right; margin-bottom:4%; opacity:0.95;"></div></div>
													<div class="col-md-12">
				...
				<tbody>
					<?php
									...
									while($row = $profile_lastmatches->fetch_array(MYSQLI_ASSOC))
									{
										...
										<td data-order="'.$row['champion_id'].'" width="8%" style="background-color:'.$bgcolor_team.';"><a href="'.URL.'/champions/'.champidtoname($row['champion_id']).'"><img width="100%" draggable="false" src="'.URL.'/style/images/base/champions/little/'.champidtoname($row['champion_id']).'.png"></a><div style="margin-top:-28%;">'.$row['champ_level'].'</div><div class="row" style="margin-left:4%;"><img draggable="false" width="40%" src="'.URL.'/style/images/base/summoners/spells/'.$row['spell1'].'.png"><img width="40%" draggable="false" src="'.URL.'/style/images/base/summoners/spells/'.$row['spell2'].'.png"></div></td>
										<td data-order="'.$row['champion_id'].'"><a style="color:white;" href="'.URL.'/champions/'.champidtoname($row['champion_id']).'">'.champidtoname($row['champion_id']).'<a></td>
									...
									?>
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="badges">POlacas</div>
                                            <div role="tabpanel" class="tab-pane fade" id="runes">runas</div>
                                            <div role="tabpanel" class="tab-pane fade" id="masteries">maestrias</div>
                                            <div role="tabpanel" class="tab-pane fade" id="teams">teams</div>
                                            <div role="tabpanel" class="tab-pane fade" id="stream">Stream</div>
                                        </div>
                                    </div>
            </div>
         </div>
