													...
													if(file_exists($_SERVER['DOCUMENT_ROOT'].'/style/images/base/champions/splash/'.$champ['champ_keyname'].'_'.$skin_num.'.jpg'))
														{
														...
														else
															{
																if($db->query('SELECT has_chroma FROM lol_skins WHERE champname="'.$champ['champ_keyname'].'" AND skin_num='.$skin_num.'')->fetch_row()[0] == 'true')
																	...
																	<img draggable="false" src="'.URL.'/style/images/base/shop/rp_icon.png" style="width:4%; bottom:2%; left:1%; position:absolute; z-index:1;"> <div style="width:20%; bottom:3%; left:6%; color:white; position:absolute; z-index:1;">'.$prize.'</div> <div style="width:50%; bottom:3%; left:20%; color:white; position:absolute; z-index:1;">'.$skin[1].'</div>
																	</div>';
																	}
																else
																	{
																	...
																	echo ' <div class="item">
																	<img draggable="false" src="'.URL.'/style/images/base/champions/splash/'.$champ['champ_keyname'].'_'.$skin_num.'.jpg"/>
																	<img draggable="false" src="'.URL.'/style/images/base/shop/rp_icon.png" style="width:4%; bottom:2%; left:1%; position:absolute; z-index:1;"> <div style="width:15%; bottom:3%; left:6%; color:white; position:absolute; z-index:1;">'.$prize.'</div> <div style="width:50%; bottom:3%; left:20%; color:white; position:absolute; z-index:1;">'.$skin[1].'</div>
																	</div>';
																	}
															}
														}
