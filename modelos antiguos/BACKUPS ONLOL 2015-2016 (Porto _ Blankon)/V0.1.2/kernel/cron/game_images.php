...
if(onlol::config('lol_patch_images') != $last_version)
{
	...
	{
		onlol::setlog('cron_images', 'Downloaded rune image '.$data['image']['full']);
		onlol::imgcompress('http://ddragon.leagueoflegends.com/cdn/'.$last_version.'/img/rune/'.$data['image']['full'], ROOTPATH.'/game/runes/'.$data['image']['full']);
	}
	/* Masteries icons */
