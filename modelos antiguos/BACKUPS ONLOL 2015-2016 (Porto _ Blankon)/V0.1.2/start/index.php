...
/* Skip intro */
if(!empty($_SESSION['onlol_skip_intro']) && empty($_GET['force']))
{
	onlol::redirect(URL.'/home',true);
}
if(!empty($_GET['force']))
{
	unset($_SESSION['onlol_skip_intro']);
}
?>
<!DOCTYPE html>
...
<!-- START @HEAD -->
<head>
	<?php echo template::meta('start_title'); ?>
				...
				<!-- START REVOLUTION SLIDER 5.0.7 fullscreen mode -->
					<div id="rev_slider_46_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.0.7">
						...
						<div class="tp-static-layers">
							...
							<!-- LAYER NR. 4 -->
							<a href="<?php echo URL ?>/home/?skip_intro=true"><div class="tp-caption NotGeneric-BigButton rev-btn  rs-parallaxlevel-0 tp-static-layer" 
								 id="slide-16-layer-7" 
