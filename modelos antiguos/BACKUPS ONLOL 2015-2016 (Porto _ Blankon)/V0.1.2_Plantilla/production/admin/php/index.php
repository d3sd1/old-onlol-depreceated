...
<head>
    ...
    <link href="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!--/ END GLOBAL MANDATORY STYLES -->

    <!-- START @PAGE LEVEL STYLES -->
     <link href="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/fontawesome/css/font-awesome.min.css" rel="stylesheet">
                <link href="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/animate.css/animate.min.css" rel="stylesheet"> <link href="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/dropzone/downloads/css/dropzone.css" rel="stylesheet">
                               <link href="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/jquery.gritter/css/jquery.gritter.css" rel="stylesheet">
                               
    <!--/ END PAGE LEVEL STYLES -->

    <!-- START @THEME STYLES -->
    <link href="http://localhost/blankon-fullpack-admin-theme/assets/admin/css/reset.css" rel="stylesheet">
                <link href="http://localhost/blankon-fullpack-admin-theme/assets/admin/css/layout.css" rel="stylesheet">
                <link href="http://localhost/blankon-fullpack-admin-theme/assets/admin/css/components.css" rel="stylesheet">
                <link href="http://localhost/blankon-fullpack-admin-theme/assets/admin/css/plugins.css" rel="stylesheet">
                <link href="http://localhost/blankon-fullpack-admin-theme/assets/admin/css/themes/php.theme.css" rel="stylesheet" id="theme">
                <link href="http://localhost/blankon-fullpack-admin-theme/assets/admin/css/custom.css" rel="stylesheet">
    <!--/ END THEME STYLES -->

    <!-- START @IE SUPPORT -->
    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
    <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/html5shiv/dist/html5shiv.min.js"></script>
    <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/respond-minmax/dest/respond.min.js"></script>
    <![endif]-->
    <!--/ END IE SUPPORT -->
</head>
<!--/ END HEAD -->
...
<li class="dropdown navbar-profile">
    ...
    <ul class="dropdown-menu animated flipInX">
        ...
        <li class="divider"></li>
        <li><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-signin"><i class="fa fa-sign-out"></i>Logout</a></li>
    </ul>
    <!--/ End dropdown menu -->
...
<li class="active">
    <a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php">
...
<li class="submenu {menuGrid} {menuList} {menuSingle}">
    ...
    <ul>
        <li class="{menuGrid}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=blog-grid">Grid</a></li>
        <li class="{menuList}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=blog-list">List</a></li>
        <li class="{menuSingle}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=blog-single">Single</a></li>
    </ul>
</li>
<!--/ End navigation - blog -->
...
<li class="submenu {menuInbox} {menuCompose} {menuView}">
    ...
    <ul>
        <li class="{menuInbox}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=mail-inbox">Inbox</a></li>
        <li class="{menuCompose}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=mail-compose">Compose mail</a></li>
        <li class="{menuView}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=mail-view">View mail</a></li>
    </ul>
</li>
<!--/ End navigation - mail -->
...
{menuSearch} {menuError403T2} {menuError404T2} {menuError500T2}">
    ...
    <ul>
        <li class="{menuGallery}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-gallery">Gallery</a></li>
        <li class="{menuFaq}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-faq">FAQ <span class="label label-danger pull-right">New</span></a></li>
        <li class="{menuInvoice}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-invoice">Invoice</a></li>
        <li class="{menuMessages}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-messages">Messages</a></li>
        <li class="{menuTimeline}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-timeline">Timeline</a></li>
        <li class="{menuProfile}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-profile">Profile</a></li>
        <li class="submenu {menuSearch}">
            <a href="javascript:void(0);">Search<span class="arrow"></span></a>
            <ul>
                <li class="{menuSearch}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-search-course">Courses</a></li>
            </ul>
        </li>
        <li class="submenu {menuError403T2} {menuError404T2} {menuError500T2}">
            <a href="javascript:void(0);">Error <span class="arrow"></span></a>
            <ul>
                <li><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-error-403">Error 403</a></li>
                <li class="{menuError403T2}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-error-403-type-2">Error 403 Type 2</a></li>
                <li><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-error-404">Error 404</a></li>
                <li class="{menuError404T2}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-error-404-type-2"">Error 404 Type 2</a></li>
                <li><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-error-500">Error 500</a></li>
                <li class="{menuError500T2}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-error-500-type-2">Error 500 Type 2</a></li>
            </ul>
        </li>
        <li class="submenu">
            <a href="javascript:void(0);">Account <span class="arrow"></span></a>
            <ul>
                <li><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-signin">Sign In</a></li>
                <li><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-signin-type-2">Sign In Type 2</a></li>
                <li><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-signup">Sign Up</a></li>
                <li><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-lost-password">Lost password</a></li>
                <li><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=page-lock-screen">Lock Screen</a></li>
            </ul>
        </li>
    </ul>
</li>
...
<li class="submenu {menuFormElement} {menuFormAdvanced} {menuFormLayout} {menuFormValidation} {menuFormWizard} {menuWysiwyg}  {menuEditable}"">
    ...
    <ul>
        <li class="{menuFormElement}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=form-elements">Element</a></li>
        <li class="{menuFormAdvanced}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=form-advanced">Advanced</a></li>
        <li class="{menuFormLayout}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=form-layout">Layout</a></li>
        <li class="{menuFormValidation}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=form-validation">Validation</a></li>
        <li class="{menuFormWizard}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=form-wizard">Wizard</a></li>
        <li class="{menuWysiwyg}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=form-wysiwyg">Text Editor</a></li>
        <li class="{menuEditable}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=form-xeditable">X-Editable</a></li>
    </ul>
</li>
...
<li class="submenu {menuTableDefault} {menuTableColor} {menuDatatable}">
    ...
    <ul>
        <li class="{menuTableDefault}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=table-default">Default</a></li>
        <li class="{menuTableColor}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=table-color">Color</a></li>
        <li class="{menuDatatable}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=table-datatable">Datatable</a></li>
    </ul>
</li>
...
<li class="submenu {menuMapsGoogle} {menuMapsVector}">
    ...
    <ul>
        <li class="{menuMapsGoogle}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=maps-google">Google</a></li>
        <li class="{menuMapsVector}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=maps-vector">Vector</a></li>
    </ul>
</li>
<!--/ End navigation - maps -->
...
<li class="submenu {menuChartFlot} {menuChartMorris} {menuChartChartjs} {menuChartC3js}">
    ...
    <ul>
        <li class="{menuChartFlot}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=chart-flot">Flot</a></li>
        <li class="{menuChartMorris}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=chart-morris">Morris</a></li>
        <li class="{menuChartChartjs}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=chart-chartjs">Chartjs</a></li>
        <li class="{menuChartC3js}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=chart-c3js">C3js</a></li>
    </ul>
</li>
...
{menuGlyphicons} {menuGlyphiconsPro} {menuFontAwesome} {menuWeatherIcons} {menuMapIcons} {menuSimpleLineIcons} {menuOthers} ">
    ...
    <ul>
        <li class="{menuGridSystem}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=grid-system">Grid System</a></li>
        <li class="{menuButtons}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=buttons">Buttons</a></li>
        <li class="{menuTypography}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=typography">Typography</a></li>
        <li class="{menuPanels}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=panels">Panels</a></li>
        <li class="{menuAlerts}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=alerts">Alerts</a></li>
        <li class="{menuModals}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=modals">Modals</a></li>
        <li class="{menuVideo}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=video">Video <span class="label label-danger pull-right">New</span></a></li>
        <li class="{menuTabsAccordion}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=tabs-accordion">Tabs & Accordion</a></li>
        <li class="{menuSliders}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=sliders">Sliders</a></li>
        <li class="submenu {menuGlyphicons} {menuGlyphiconsPro} {menuFontAwesome} {menuWeatherIcons} {menuMapIcons} {menuSimpleLineIcons}">
            ...
            <ul>
                <li class="{menuGlyphicons}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=glyphicons">Glyphicons</a></li>
                <li class="{menuGlyphiconsPro}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=glyphicons-pro">Glyphicons PRO</a></li>
                <li class="{menuFontAwesome}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=font-awesome">Font Awesome</a></li>
                <li class="{menuWeatherIcons}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=weather-icon">Weather Icons</a></li>
                <li class="{menuMapIcons}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=map-icons">Map Icons</a></li>
                <li class="{menuSimpleLineIcons}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=simple-line-icons">Simple Line Icons</a></li>
            </ul>
        </li>
        <li class="{menuOthers}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=others">Other</a></li>
    </ul>
</li>
...
{menuSidebarDefaultPage} {menuSidebarBoxPage} {menuLayoutSidebarRounded} {menuLayoutSidebarCircle} {menuLayoutFooterFixed}">
    ...
    <ul>
        <li class="{menuBlankPage}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=blank-page">Blank Page</a></li>
        <li class="{menuBoxedPage}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=boxed-page">Boxed Page</a></li>
        <li class="{menuHeaderFixedPage}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=header-fixed-page">Header Fixed Page</a></li>
        <li class="{menuSidebarFixedPage}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=sidebar-fixed-page">Sidebar Fixed Page</a></li>
        <li class="{menuSidebarMinimizePage}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=sidebar-minimize-page">Sidebar Minimize Page</a></li>
        <li class="{menuSidebarDefaultPage}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=sidebar-default-page">Sidebar Default Page</a></li>
        <li class="{menuSidebarBoxPage}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=sidebar-box-page">Sidebar Box Page</a></li>
        <li class="{menuLayoutSidebarRounded}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=layout-sidebar-rounded">Sidebar Rounded Page</a></li>
        <li class="{menuLayoutSidebarCircle}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=layout-sidebar-circle">Sidebar Circle Page</a></li>
        <li class="{menuLayoutFooterFixed}"><a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=layout-footer-fixed">Footer Fixed Page</a></li>
    </ul>
</li>
...
<li {menuAnimate}>
    <a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=animate">
...
<li class="{menuOverview}">
    <a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=overview">
...
<!-- Start widget - social -->
<li class="{menuSocial}">
    <a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=social">
...
<!-- Start widget - blog -->
<li class="{menuBlog}">
    <a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=blog">
...
<li class="{menuWeather}">
    <a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=weather">
...
<!-- Start widget - misc -->
<li class="{menuMisc}">
    <a href="http://localhost/blankon-fullpack-admin-theme/production/admin/php/index.php?v=misc">
...
<!-- START @CORE PLUGINS -->
  <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/jquery/dist/jquery.min.js"></script>
                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/jquery-cookie/jquery.cookie.js"></script>
                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/typehead.js/dist/handlebars.js"></script>
                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/typehead.js/dist/typeahead.bundle.min.js"></script>
                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/jquery-nicescroll/jquery.nicescroll.min.js"></script>
                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/jquery.sparkline.min/index.js"></script>
                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/jquery-easing-original/jquery.easing.1.3.min.js"></script>
                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/ionsound/js/ion.sound.min.js"></script>
                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/bootbox/bootbox.js"></script>
                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/retina.js/dist/retina.min.js"></script>
<!--/ END CORE PLUGINS -->

<!-- START @PAGE LEVEL PLUGINS -->
 <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/bootstrap-session-timeout/dist/bootstrap-session-timeout.min.js"></script>
                                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/flot/jquery.flot.js"></script>
                                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/flot/jquery.flot.spline.min.js"></script>
                                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/flot/jquery.flot.categories.js"></script>
                                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/flot/jquery.flot.tooltip.min.js"></script>
                                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/flot/jquery.flot.resize.js"></script>
                                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/flot/jquery.flot.pie.js"></script>
                                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/dropzone/downloads/dropzone.min.js"></script>
                                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/jquery.gritter/js/jquery.gritter.min.js"></script>
                                <script src="http://localhost/blankon-fullpack-admin-theme/assets/global/plugins/bower_components/skycons-html5/skycons.js"></script>
                            
<!--/ END PAGE LEVEL PLUGINS -->

<!-- START @PAGE LEVEL SCRIPTS -->
 <script src="http://localhost/blankon-fullpack-admin-theme/assets/admin/js/apps.js"></script>
                                <script src="http://localhost/blankon-fullpack-admin-theme/assets/admin/js/pages/blankon.dashboard.js"></script>
                                <script src="http://localhost/blankon-fullpack-admin-theme/assets/admin/js/demo.js"></script>
