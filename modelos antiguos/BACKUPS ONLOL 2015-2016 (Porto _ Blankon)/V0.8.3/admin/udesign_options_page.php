...
class UDESIGN_Theme_Options {
	...
	function on_load_page() {
		...
		wp_enqueue_script('ud-colorpicker');
                ...
                $url = "http://code.jquery.com/ui/".$queryui->ver."/themes/flick/jquery-ui.min.css";
	...
	function udesign_generate_options_page() {
		...
		<div id="udesign-metaboxes-general" class="wrap">
		    ...
		    <h2 style="padding-top:25px; padding-bottom: 30px;"><?php printf( __('Options <small>(version %1$s)</small>', 'udesign'), UDESIGN_VERSION ); ?></h2>
<?php 
