...
if ( $udesign_options['recaptcha_enabled'] == 'yes' ) {
    require_once( trailingslashit( get_template_directory() ) . 'scripts/recaptcha/recaptchalib.php' );
    // Register API keys at https://www.google.com/recaptcha/admin
    $siteKey = $udesign_options['recaptcha_publickey'];
    $secret = $udesign_options['recaptcha_privatekey'];
...
if( isset($_POST['submit']) ) {
    ...
    if( ( $udesign_options['recaptcha_enabled'] == 'yes' ) && ( ( null === $resp || $resp->errorCodes ) || $g_recaptcha_response == '' ) ) {
...
<?php                       if ( isset( $_POST['submit'] ) && ( null === $resp || $resp->errorCodes ) ) {
