...
!function (a) {
    ...
    return function a(b, c, d) {
        ...
        return e
                    ...
                    function k(a, b, g, i, j) {
                        function k(c) {
                            ...
                            if (k.entryPath = k.currentDirectory, k.rootpath = l.rootpath || k.currentDirectory, j) {
                                ...
                                var m = t.getCSS(h, j);
                                if (!g && m)
                                    return d.createCSS(e.document, m, a), j.local = !0, void b(null, null, f, a, j, h)
                            }
                ...
                b.exports = function (a, b) {
                    var c = 4, d = 3, e = 2, f = 1;
                    b.logLevel = "undefined" != typeof b.logLevel ? b.logLevel : "development" === b.env ? d : f, b.loggers || (b.loggers = [{debug: function (a) {
                ...
                b.exports = function (b) {
                    ...
                    e.add("data-uri", function (a, e) {
                        ...
                        if (!p.contents)
                            return g.warn("Skipped data-uri embedding because file not found"), f(this, e || a);
                        var q = p.contents, r = 32, s = parseInt(q.length / 1024, 10);
                        if (s >= r && this.context.ieCompat !== !1)
                            return g.warn("Skipped data-uri embedding of %s because its size (%dKB) exceeds IE8-safe %dKB!", i, s, r), f(this, e || a);
                ...
                b.exports = function (b) {
                    ...
                    g.add("svg-gradient", function (a) {
                        ...
                        for (i = '<?xml version="1.0" ?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%" viewBox="0 0 1 1" preserveAspectRatio="none"><' + p + 'Gradient id="gradient" gradientUnits="userSpaceOnUse" ' + h + ">", j = 0; j < o.length; j += 1)
                            o[j].value ? (k = o[j].value[0], l = o[j].value[1]) : (k = o[j], l = void 0), k instanceof d && ((0 === j || j + 1 === o.length) && void 0 === l || l instanceof c) || g(), m = l ? l.toCSS(s) : 0 === j ? "0%" : "100%", n = k.alpha, i += '<stop offset="' + m + '" stop-color="' + k.toRGB() + '"' + (1 > n ? ' stop-opacity="' + n + '"' : "") + "/>";
                ...
                i.addMultiple({iscolor: function (a) {
                        ...
                        if (!(a instanceof c))
                            throw{type: "Argument", message: "the first argument to unit must be a number" + (a instanceof h ? ". Have you forgotten parenthesis?" : "")};
                ...
                b.exports = function (a) {
                    ...
                    return b.prototype.push = function (b, e, f, g, h) {
                        ...
                        if (!l)
                            return void j({message: "Could not find a file-manager for " + b});
                    ...
                    return b.prototype.toCSS = function (b) {
                        ...
                        if (b.pluginManager)
                            for (var j = b.pluginManager.getPostProcessors(), k = 0; k < j.length; k++)
                                g.css = j[k].process(g.css, {sourceMap: f, options: b, imports: this.imports});
                    ...
                    return{parse: function (f, g, j) {
                            ...
                            return a.processImports === !1 ? t() : void new e.ImportVisitor(b, t).run(k)
                                ...
                                if (o.commentStore.length) {
                                    ...
                                    var a, b, c, e, f = o.i;
                                    if (!o.peek(/^url\(/i))
                                        return o.save(), (a = o.$re(/^([\w-]+|%|progid:[\w\.]+)\(/)) ? (a = a[1], b = a.toLowerCase(), "alpha" === b && (e = n.alpha()) ? e : (c = this.arguments(), o.$char(")") ? (o.forget(), new d.Call(a, c, f, h)) : void o.restore("Could not parse call arguments or missing ')'"))) : void o.forget()
                                }, arguments: function () {
                                    for (var a, b = []; ; ) {
                                ...
                                for (o.save(), a(/^(\*?)/); ; )
                                    if (!a(/^((?:[\w-]+)|(?:@\{[\w-]+\}))/))
                                        break;
                                if (e.length > 1 && a(/^((?:\+_|\+)?)\s*:/)) {
                                    for (o.forget(), "" === e[0] && (e.shift(), f.shift()), c = 0; c < e.length; c++)
                ...
                b.exports = function (a, b, g) {
                    var h = function (a, i, j) {
                        ...
                        if (m.addPlugins(i.plugins), i.pluginManager = m, k = new d.Parse(i), i.rootFileInfo)
                            l = i.rootFileInfo;
                        else {
                ...
                b.exports = function (a, b) {
                    ...
                    for (i = 0; i < j.length; i++)
                        j[i].run(a);
                    for (f = a.eval(h), i = 0; i < k.length; i++)
                        k[i].run(f);
                    return f
                }
                ...
                g.prototype = new c, g.prototype.type = "Dimension", g.prototype.accept = function (a) {
                    ...
                    if ("+" === b || "-" === b)
                        if (0 === e.numerator.length && 0 === e.denominator.length)
                            e.numerator = c.unit.numerator.slice(0), e.denominator = c.unit.denominator.slice(0);
                ...
                e.prototype = new c, e.prototype.evaluateJavaScript = function (a, b) {
                    ...
                    for (var i in h)
                        h.hasOwnProperty(i) && (f[i.slice(1)] = {value: h[i].value, toJS: function () {
                    ...
                    for (h = this.arguments && this.arguments.map(function (b) {
                        ...
                        if ((c = a.frames[i].find(this.selector, null, s)).length > 0) {
                            ...
                            if (q[y] > 0)
                                ...
                                throw{type: "Runtime", message: "Ambiguous use of `default()` found when matching for `" + this.format(h) + "`", index: this.index, filename: this.currentFileInfo.filename};
                ...
                j.prototype = new c, j.prototype.type = "Ruleset", j.prototype.isRuleset = !0, j.prototype.isRulesetLike = !0, j.prototype.accept = function (a) {
                    ...
                    if (g && (c = g.length)) {
                        for (b = [], h.error({type:"Syntax", message:"it is currently only allowed in parametric mixin guards,"}), f = 0; c > f; f++)
                    ...
                    if (l = k.concat(l), !this.root) {
                        ...
                        for (n = a.compress?",":",\n" + p, d = 0; s > d; d++)
                            if (j = r[d], q = j.length)
                                for (d > 0 && b.add(n), a.firstSelector = !0, j[0].genCSS(a, b), a.firstSelector = !1, e = 1; q > e; e++)
                                    j[e].genCSS(a, b);
                        b.add((a.compress ? "{" : " {\n") + o)
                    }
                    ...
                    if (this.root || (b.add(a.compress ? "}" : "\n" + p + "}"), a.tabLevel--), n = (a.compress ? "" : "\n") + (this.root ? o : p), f = m.length)
                        for (l.length && n && b.add(n), m[0].genCSS(a, b), d = 1; f > d; d++)
                    ...
                    if (h) {
                        for (r = [], i = [[]], d = 0; d < c.elements.length; d++)
                            if (j = c.elements[d], "&" !== j.value)
                                r.push(j);
                            else {
                                for (s = [], r.length > 0 && this.mergeElementsOnToSelectors(r, i), e = 0; e < i.length; e++)
                                    if (k = i[e], 0 === b.length)
                                        k.length > 0 && (k[0].elements = k[0].elements.slice(0), k[0].elements.push(new f(j.combinator, "", j.index, j.currentFileInfo))), s.push(k);
                                    else
                        ...
                        for (r.length > 0 && this.mergeElementsOnToSelectors(r, i), d = 0; d < i.length; d++)
                ...
                d.prototype = new c, d.prototype.type = "Variable", d.prototype.eval = function (a) {
                    ...
                    if (0 === c.indexOf("@@") && (c = "@" + new d(c.slice(1), this.index, this.currentFileInfo).eval(a).value), this.evaluating)
                        throw{type: "Name", message: "Recursive variable definition for " + c, filename: this.currentFileInfo.filename, index: this.index};
                ...
                e.prototype = {isReplacing: !0, run: function (a) {
                        ...
                        for (var b, d = 0; d < a.length; d++)
                            if (b = a[d], b instanceof c.Rule && !b.variable)
                                throw{message: "properties must be inside selector blocks, they cannot be in the root.", index: b.index, filename: b.currentFileInfo ? b.currentFileInfo.filename : null}
