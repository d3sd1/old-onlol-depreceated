...
<html lang="en">
    <head>
         <title>ONLoL ~ Distribución de invocadores</title>
        <meta charset="utf-8">
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Distribución de invocadores',
        },
        plotOptions: {
            pie: {
                innerSize: 100,
        ...
        series: [{
			name: 'Número de invocadores',
            data: [
                {
                name: 'Bronce',
                y: <?php echo retstat('rank_distribution_bronze'); ?>,
                color: '#cc6633'
            },
			{
                name: 'Plata',
                y: <?php echo retstat('rank_distribution_silver'); ?>,
                color: '#cccccc'
            },
			{
                name: 'Oro',
                y: <?php echo retstat('rank_distribution_gold'); ?>,
                color: '#ffcc00'
            },
			{
                name: 'Platino',
                y: <?php echo retstat('rank_distribution_platinum'); ?>,
                color: '#397670'
            },
			{
                name: 'Diamante',
                y: <?php echo retstat('rank_distribution_diamond'); ?>,
                color: '#1e789e'
            },
			{
                name: 'Maestro',
                y: <?php echo retstat('rank_distribution_master'); ?>,
                color: '#c0883b'
            },
			{
                name: 'Aspirante',
                y: <?php echo retstat('rank_distribution_challenger'); ?>,
                color: '#fff780'
            }
            ]
        }]
            ...
            <section class="content container no-padding" style="opacity:0.90;">
                <div class="row">
                    <div class="col-md-12" style="background-image: url(<?php echo URL ?>/style/images/home/bg/11.jpg); background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
							<div id="container" style="min-width: 410px; max-width: 600px; height: 400px; margin: 5% auto"></div>
                    </div>
                </div>
            </section>
